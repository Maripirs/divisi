...
class UserOut(BaseModel):
    id: str
    # Plain `str`, not `EmailStr`: an anonymous participant (B19/B21) keeps
    # its synthetic `@participants.divisi.invalid` address, which is
    # intentionally non-routable and fails email validation.
    email: str
    name: str
